...
conn.bye = '*╔══════════════*\n*╟❧ @user*\n*╟❧ 𝙷𝙰𝚂𝚃𝙰 𝙿𝚁𝙾𝙽𝚃𝙾 👋🏻* \n*╚══════════════*'
conn.spromote = '🔥 *↑ @user haz sido promovidx a ADMIN* 🔥\n👑 _𝐌øɉɨŧø se enorgullece.._'
conn.sdemote = '💢 *↓ @user perdiste el privilegio de ser ADMIN*\n_Bienvenidx al mundo de los mortales_ 🤑\n\n*𝐌øɉɨŧø c rie 😆'
